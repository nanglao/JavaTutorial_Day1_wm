...
public class AccessoriesAdapt extends RecyclerView.Adapter<AccessoriesAdapt.MyViewHolder>{
    ...
    public AccessoriesAdapt(List<BestDealModel> accessoriesList) {
    ...
    @Override
    public AccessoriesAdapt.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.layout_best_deal_home, parent, false);
        return new AccessoriesAdapt.MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(AccessoriesAdapt.MyViewHolder holder, int position) {
